...
Adding tests to your subworkflow is near identical to modules. For detailed instructions, please see [here](/nf-neuro/contribute/create-your-module/tests#create-test-cases).
