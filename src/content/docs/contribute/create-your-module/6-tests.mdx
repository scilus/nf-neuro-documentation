...
To configure the `task.ext` parameters of the module, use the `config` parameter, either **globally** or at the scope of
the test case, to import a `nextflow.config` file. Refer to [this section](/nf-neuro/contribute/create-your-module/3-configuration) to
