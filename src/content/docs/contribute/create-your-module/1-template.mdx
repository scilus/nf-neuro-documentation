...
This tutorial series explains how to contributea module to `nf-neuro`. For the purpose of this tutorial, you will
create a module that denoises T1w images using the **Non-Local Means** (NLM) algorithm's implementation
...
<span class="text-blue-400">**[Skip if working in the devcontainer]**</span> If not done already, clone the `nf-neuro` repository locally
and navigate to it :
