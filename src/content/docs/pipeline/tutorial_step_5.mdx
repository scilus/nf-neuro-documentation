...
## Step 5:  Install and use a nf-neuro subworkflow
...
To include a T1w image in the pipeline, follow the approach from [**Step 2**](/nf-neuro/pipeline/tutorial_step_2) for adding DWI images.
...
### 3. Use the subworkflow and prepare the input subworkflow structure
...
Add the `-resume` option to your command line, so you don't recompute each image again.
