...
By following step 7, you will learn to create your own local subworkflow.
:::

In this step, we will create a local subworkflow called `PREPROC_DIFF` which will include 
...
optionally apply denoising, and compute DTI-derived metrics. 
    ...
    4. Implement `main:`
        ...
        2a- Use the parameter name : `preproc_dwi_run_denoising`
    ...
    **Expected ./subworkflows/local/preproc_diff/main.nf**
    ```nextflow
        include { RECONST_DTIMETRICS } from '../../../modules/nf-neuro/reconst/dtimetrics/main'
        include { DENOISING_MPPCA } from '../../../modules/nf-neuro/denoising/mppca/main'
