...
## Step 3: Use and configure a nf-neuro module
...
To do this, we will go through 6 successive sub-steps:
...
6. Visualize data from the result folder
</Steps>
...
### 6. Visualize data in result folder
