...
By following steps 1 to 4, you will learn the input structure and how to install and use your first nf-neuro module.
:::
...
:::note
You can get more information about this method using through nextflow [API](https://www.nextflow.io/docs/latest/reference/channel.html#fromfilepairs)
:::

<RunIcon class="inline-icon text-blue-300" aria-hidden /> **You can now run nextflow.**
...
using the following structure and `it`. Replace the fromFilePairs call.
...
```
    ...
    <html>
    <li>`it` corresponds to the file name (here: /workspaces/nf-neuro-tutorial_test/data/sub-003/ses-01/dwi/sub-003_ses-01_dir-AP_dwi.bval).</li>
    <li>`.parent` corresponds to the parent folder.</li>
    </html>
