...
3. Understand input data specific to the module
    ...
    Like the DTI module, the MPPCA denoising module requires only the DWI image and an optional mask.
    ...
    <ul>
        ...
        <li>bvs_files: This output contains the meta information, bval file, and bvec file.</li>
...
5. Adapt the input for `RECONST_DTIMETRICS` module to integrate denoised DWI before.
