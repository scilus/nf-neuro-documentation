---
title: Creating your own subworkflow
...
Adding tests to your subworkflow is near identical to modules. For detailed instructions, please see {pagelink("here", "/guides/modules#create-test-cases")}.
