...
1. First, remove the line `conda "YOUR-TOOL-HERE"`. As of now, we do not use
conda to package softwares, so we don't need it.

2. Second, you need to specify a [docker](https://hub.docker.com/) container to
