...
{pagelink("guide here", "/guides/nfneuro_devcontainer")} to do so. You can also use
{pagelink("those instructions", "/guides/basic_environment")} to setup yourself manually.
