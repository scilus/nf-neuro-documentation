...
{pagelink("guide here", "/guides/environments/devcontainers/prototyping")} to do so. You can also use
{pagelink("those instructions", "/guides/environments/nf-core")} to setup yourself manually.
...
<Callout variant="success" title="Call you pipeline !">
Once your pipeline is built, or when you want to test it, run :
```
nextflow run main.nf --input <directory>
```

You can find example **input data** [here](dummy.link.to.updata) or use any of your own, as long
