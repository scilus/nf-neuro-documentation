...
[documentation](/guides/environments/devcontainers/prototyping) to do so. You can also use
[those instructions](/guides/environments/nf-core) to setup yourself manually.
