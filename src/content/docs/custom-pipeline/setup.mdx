...
in **VSCode**, configured with [nf-neuro](https://github.com/scilus/nf-neuro) and
...
3. **Search and select** `scilus/nf-neuro-tutorial`. Set a download location for the repository
   when asked, anywhere is fine.

   ![vscode find nf-neuro-tutorial](../../../assets/images/vscode-clone-selection.png)
...
4. **nf-test**
   ...
   Test [98c90c05] 'reconst - dtimetrics' PASSED (135.975s)
   Test [8dc8917f] 'reconst - dtimetrics_with_b0mask' PASSED (46.21s)
   Test [4ab7ab0c] 'reconst - stub-run dtimetrics' PASSED (16.64s)


   SUCCESS: Executed 3 tests in 198.85s
   ```
   </span>
   </CommandOutputs>
