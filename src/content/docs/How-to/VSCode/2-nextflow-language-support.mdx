...
VSCode editor by the container. In the <span class="dark:text-blue-300 text-blue-500">Explorer</span>, click on the `main.nf`
file located at the root of the workspace.

Once it opens in the <span class="dark:text-blue-300 text-blue-500">editor area</span>, hover above the various line of codes.
When possible, tooltips will display, giving relevant information on the item hovered above. Tooltips for
items from the **official nextflow language** will display an aditional <span class="dark:text-blue-300 text-blue-500">Read More</span>
